...
public class ContainerBox extends Container{
	...
	// Stores a reference to the tile entity instance for later use
		...
		public ContainerBox(InventoryPlayer invPlayer, TileEntityBox tileEntityInventoryBasic) {
			this.tileEntityInventoryBasic = tileEntityInventoryBasic;

			final int SLOT_X_SPACING = 18;
	    final int SLOT_Y_SPACING = 18;
			final int HOTBAR_XPOS = 8;
			final int HOTBAR_YPOS = 157-15;
			...
			final int PLAYER_INVENTORY_YPOS = 99-15;
			...
			final int TILE_INVENTORY_YPOS = 33-15;
			// Add the tile inventory container to the gui
				for (int x = 0; x < 9; x++) {
					for(int y = 0; y < 3; y++)
					{
					int slotNumber = x * 3 + y;
