package wilby.argh.common.gui.container;
...
public class ContainerItemEnergiser extends Container{
	...
	// Stores a reference to the tile entity instance for later use
		...
		public ContainerItemEnergiser(InventoryPlayer invPlayer, TileEntityItemEnergiser tileEntityInventoryBasic) {
			this.tileEntityInventoryBasic = tileEntityInventoryBasic;

			final int SLOT_X_SPACING = 18;
	    final int SLOT_Y_SPACING = 18;
			final int HOTBAR_XPOS = 8;
			final int HOTBAR_YPOS = 157-48;
			...
			final int PLAYER_INVENTORY_YPOS = 99-48;
			...
			final int TILE_INVENTORY_YPOS = 22;
			addSlotToContainer(new Slot(tileEntityInventoryBasic, 0, 8, 20));
			addSlotToContainer(new Slot(tileEntityInventoryBasic, 1, 62, 20));
